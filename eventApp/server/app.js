...
baseOption.target = extractBaseURL(config.server_info.apiURLEvent); // target host
baseOption.pathRewrite = {
    '^/api': extractSubURL(config.server_info.apiURLEvent)
};
app.use('/api', proxy(baseOption));

// Substation proxy
baseOption.target = extractBaseURL(config.server_info.apiURLSubstation); // target host
baseOption.pathRewrite = {
    '^/substation': extractSubURL(config.server_info.apiURLSubstation)
};
app.use('/substation', proxy(baseOption));
//===================================
